...
export default class ControlEditing extends Plugin {
    ...
    _defineConverters() {
            ...
            function createControlView(modelItem, viewWriter) {
                ...
                try {
                    if (type === ControlType.LUA_CHON) {
                        ...
                        cardView = viewWriter.createContainerElement('span', { class: classes, 'data-type': type, 'data-id': id }, viewWriter.createContainerElement('span', { class: 'number-options', 'data-value': 'Chọn' }, [
                        ...
                        return viewWriter.createContainerElement('span', { class: classes, 'data-type': type, 'data-id': id },
                        ...
                        cardView = viewWriter.createContainerElement('span', { class: classes, 'data-type': type, 'data-id': id }, viewWriter.createContainerElement('span', { class: 'frac frac-input' }, childrenElements));
                        ...
                        cardView = viewWriter.createContainerElement('span', { class: classes, 'data-type': type, 'data-id': id }, viewWriter.createContainerElement('span', { class: 'division' }, [
            ...
            function getControlDataFromViewElement(viewElement) {
                try {
                    const controlId = viewElement.is('element', 'span') ? viewElement.getAttribute('data-id') : genId();
        ...
        this.listenTo(viewDocument, 'clipboardInput', (evt, data) => {
            ...
            try {
                ...
                if (control.type === ControlType.LUA_CHON) {
                    ...
                    writer.appendChild(
                        writer.createElement('span', { class: 't-control', 'data-type': control.type, 'data-id': sharedId }, optionsElement),
                        fragment);
